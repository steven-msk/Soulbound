namespace SoulboundEngine.Client.Debug.Logging {
...
#nullable enable
	...
	public class UnityClientLoggerWrapper : ILoggerWrapper {
		...
		private void LogMessage(
			...
			if (exception != null) this.unityLogger.LogException(exception, context);
		}
		...
		public void LogFatal(Exception? exception, object message, UnityEngine.Object context) {
