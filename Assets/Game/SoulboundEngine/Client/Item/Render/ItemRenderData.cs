...
namespace SoulboundEngine.Client.ItemSystem.Render {
	public readonly struct ItemRenderData {
		...
		public readonly AtlasSpriteRef spriteRef;
		...
		public ItemRenderData(AtlasSpriteRef spriteRef, ItemStack itemStack, Identifier? spriteAnimation)
			: this(itemStack.quantity, itemStack.item.IsStackable(), spriteRef, spriteAnimation) {
		}

		public ItemRenderData(int stackQuantity, bool isStackable, AtlasSpriteRef spriteRef, Identifier? spriteAnimation) {
		...
		public static AtlasSpriteRef GetSpriteFromDefaultAtlas(string spriteKey) {
			const string defaultAtlas = "Items";

			return new AtlasSpriteRef(new AssetKey(defaultAtlas), spriteKey);
		}
	}
}
