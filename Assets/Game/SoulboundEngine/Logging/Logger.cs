...
#nullable enable
	...
	public static partial class Logger {
		...
		public static void LogWarning(string message, params object[] args) {
			wrapper?.LogWarning(message, args);
		}
		...
		public static void LogError(string message, params object[] args) {
			wrapper?.LogError(message, args);
		}

		public static void LogFatal(Exception? exception, object message) {
			wrapper?.LogFatal(exception, message);
		}
		public static void LogFatal(Exception? exception, string message, params object[] args) {
			wrapper?.LogFatal(exception, message, args);
		}
		public static void LogFatal(Exception? exception) {
			wrapper?.LogFatal(exception);
		}
	}
}
