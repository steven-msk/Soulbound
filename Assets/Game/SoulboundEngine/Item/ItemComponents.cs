...
#nullable enable
	...
	public static class ItemComponents {
		public static readonly ComponentType<string> NAME = Register<string>("name", b => b.Codec(BuiltinCodecs.STRING));
		public static readonly ComponentType<int> MAX_STACK_COUNT = Register<int>("max_stack_count", b => b.Codec(BuiltinCodecs.INT));
		public static readonly ComponentType<int> BREAK_LEVEL = Register<int>("break_level", b => b.Codec(BuiltinCodecs.INT));
		public static readonly ComponentType<int> DURABILITY = Register<int>("durability", b => b.Codec(BuiltinCodecs.INT));
