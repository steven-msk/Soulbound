...
namespace SoulboundBackend.Client.Stats {
	...
	public static class StatProcessors {
		...
		//		public float ProcessFinalValue(
		//				float baseValue, 
		//				IEnumerable<IStatEntryModifier<float>> modifiers,
		//				Dictionary<IStatEntryModifier<float>, IModificationProcedure<float>> procedures
		//		) {
