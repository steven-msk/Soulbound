...
namespace SoulboundEngine.Client.World.BlockSystem {
	public partial class Blocks {
		...
		public static readonly Block grass = Registry<Block>.Add(new GenericBlock(Identifier.Of("grass"), "Grass Block", new AssetKey("grass"), 0));
		public static readonly Block dirt = Registry<Block>.Add(new GenericBlock(Identifier.Of("dirt"), "Dirt Block", new AssetKey("dirt"), 0));
		public static readonly Block stone = Registry<Block>.Add(new GenericBlock(Identifier.Of("stone"), "Stone Block", new AssetKey("stone"), 1));
		public static readonly Block wood = Registry<Block>.Add(new GenericBlock(Identifier.Of("wood"), "Wood", new AssetKey("wood"), 0));
